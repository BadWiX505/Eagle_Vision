...
export type ActiveTab = "live" | "evidence";
...
export interface DashboardState {
  ...
  /** Active dashboard tab: "live" view or "evidence" panel. */
  activeTab: ActiveTab;
  /** Stored violence detection snapshots. */
  violenceDetections: ViolenceDetection[];
  /** ID of the detection whose person-identification modal is open; null when closed. */
  identifyingDetectionId: string | null;
  ...
  setViolenceDetections: (detections: ViolenceDetection[]) => void;
  setIdentifyingDetectionId: (id: string | null) => void;
}
