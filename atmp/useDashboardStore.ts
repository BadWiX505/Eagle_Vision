...
import type { DashboardState, Camera, Alert, SystemMode, BoundingBox, CameraPosition, RailDirection, ActiveTab, ViolenceDetection } from "@/types";
...
export const useDashboardStore = create<DashboardState>((set) => ({
  ...
  trackerLocked: false,
  activeTab: "live" as ActiveTab,
  violenceDetections: [] as ViolenceDetection[],
  identifyingDetectionId: null,
  ...
  setViolenceDetections: (detections: ViolenceDetection[]) =>
    set({ violenceDetections: detections }),

  setIdentifyingDetectionId: (id: string | null) =>
    set({ identifyingDetectionId: id }),
}));
